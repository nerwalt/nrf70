...
use super::Rpu;
use crate::bindings::{
    CALIB_XO_FLAG_MASK, CSP_HB_MAX_PWR_BKF_HI_TEMP, CSP_HB_MAX_PWR_BKF_LOW_TEMP, CSP_HB_VBT_LT_LOW, CSP_HB_VBT_LT_VLOW,
    CSP_LB_MAX_PWR_BKF_HI_TEMP, CSP_LB_MAX_PWR_BKF_LOW_TEMP, CSP_LB_VBT_LT_LOW, CSP_LB_VBT_LT_VLOW, CSP_MAX_CHIP_TEMP,
    CSP_MAX_TX_PWR_DSSS, CSP_MAX_TX_PWR_HB_HIGH_CHAN_MCS0, CSP_MAX_TX_PWR_HB_HIGH_CHAN_MCS7,
    CSP_MAX_TX_PWR_HB_LOW_CHAN_MCS0, CSP_MAX_TX_PWR_HB_LOW_CHAN_MCS7, CSP_MAX_TX_PWR_HB_MID_CHAN_MCS0,
    CSP_MAX_TX_PWR_HB_MID_CHAN_MCS7, CSP_MAX_TX_PWR_LB_MCS0, CSP_MAX_TX_PWR_LB_MCS7, CSP_MIN_CHIP_TEMP,
    CSP_PACKAGE_INFO, CSP_SYSTEM_OFFSET_HB_CHAN_HIGH, CSP_SYSTEM_OFFSET_HB_CHAN_LOW, CSP_SYSTEM_OFFSET_HB_CHAN_MID,
    CSP_SYSTEM_OFFSET_LB, CSP_XO_VAL, CTRL_PWR_OPTIMIZATIONS, EDGE_BACKOFF_OFFSETS, FT_PROG_VER_MASK,
    FT_PROG_VER1_2G_DSSS_TXCEIL_BKOFF, FT_PROG_VER1_2G_OFDM_TXCEIL_BKOFF, FT_PROG_VER1_5G_HIGH_OFDM_TXCEIL_BKOFF,
    FT_PROG_VER1_5G_LOW_OFDM_TXCEIL_BKOFF, FT_PROG_VER1_5G_MID_OFDM_TXCEIL_BKOFF, FT_PROG_VER2_2G_DSSS_TXCEIL_BKOFF,
    FT_PROG_VER2_2G_OFDM_TXCEIL_BKOFF, FT_PROG_VER2_5G_HIGH_OFDM_TXCEIL_BKOFF, FT_PROG_VER2_5G_LOW_OFDM_TXCEIL_BKOFF,
    FT_PROG_VER2_5G_MID_OFDM_TXCEIL_BKOFF, FT_PROG_VER3_2G_DSSS_TXCEIL_BKOFF, FT_PROG_VER3_2G_OFDM_TXCEIL_BKOFF,
    FT_PROG_VER3_5G_HIGH_OFDM_TXCEIL_BKOFF, FT_PROG_VER3_5G_LOW_OFDM_TXCEIL_BKOFF,
    FT_PROG_VER3_5G_MID_OFDM_TXCEIL_BKOFF, NRF_WIFI_RF_PARAMS_CONF_SIZE, NRF_WIFI_SYS_DEF_RF_PARAMS, OTP_OFF_CALIB_XO,
    PD_ADJUST_VAL, QFN_HB_MAX_PWR_BKF_HI_TEMP, QFN_HB_MAX_PWR_BKF_LOW_TEMP, QFN_HB_VBT_LT_LOW, QFN_HB_VBT_LT_VLOW,
    QFN_LB_MAX_PWR_BKF_HI_TEMP, QFN_LB_MAX_PWR_BKF_LOW_TEMP, QFN_LB_VBT_LT_LOW, QFN_LB_VBT_LT_VLOW, QFN_MAX_CHIP_TEMP,
    QFN_MAX_TX_PWR_DSSS, QFN_MAX_TX_PWR_HB_HIGH_CHAN_MCS0, QFN_MAX_TX_PWR_HB_HIGH_CHAN_MCS7,
    ...
    QFN_SYSTEM_OFFSET_HB_CHAN_HIGH, QFN_SYSTEM_OFFSET_HB_CHAN_LOW, QFN_SYSTEM_OFFSET_HB_CHAN_MID, QFN_SYSTEM_OFFSET_LB,
    QFN_XO_VAL, RPU_MEM_OTP_FT_PROG_VERSION, RPU_MEM_OTP_PACKAGE_TYPE, RX_GAIN_OFFSET_HB_HIGH_CHAN,
    RX_GAIN_OFFSET_HB_LOW_CHAN, RX_GAIN_OFFSET_HB_MID_CHAN, ft_prog_ver, host_rpu_umac_info, nrf_wifi_pd_adst_val,
    nrf_wifi_phy_rf_params, nrf_wifi_rx_gain_offset, nrf_wifi_temp_volt_depend_params, nrf_wifi_tx_pwr_ceil,
    nrf_wifi_tx_pwr_ceil_params, nrf_wifi_tx_pwr_systm_offset, nrf_wifi_xo_freq_offset,
};
use crate::bus::Bus;
